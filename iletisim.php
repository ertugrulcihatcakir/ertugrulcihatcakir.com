	...
	<div class="container-contact100">
		<div class="wrap-contact100">
			<form class="contact00-form validate-form" method="post">
				...
				<label class="label-input100" >Mesajınız </label>
				<div class="wrap-input100 validate-input">
					<textarea class="input100" type="text" name="bilgi" placeholder="  Mesajınız.. "></textarea>
				</div>
...
if ($_POST) { // Sayfada post olup olmadığını kontrol ediyoruz.
  ...
  if ($ad<>"" && $soyad<>"" && $eposta<>"" && $telefon<>"" && $mesaj<>"") 
  { // Veri alanlarının boş olmadığını kontrol ettiriyoruz. başka kontrollerde yapabilirsiniz.
    if ($baglanti->query("INSERT INTO mesaj (ad,soyad,eposta,telefon,mesaj) VALUES ('$ad','$soyad','$eposta','$telefon','$mesaj')")) // Veri ekleme sorgumuzu yazıyoruz.
    {
    }
  }
